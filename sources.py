...
Продукты выбраны зеркально линейке своего банка (own): кредитная карта, карта рассрочки
...
BANKS = {
    ...
    "ozon": dict(name="свой банк (own)", regnum=3542, host="finance.ozon.ru", pages={
