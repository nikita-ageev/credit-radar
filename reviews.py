...
def banki_ratings(slug):
    ...
    if agg.get("rating") is None and agg.get("place") is None:
        ...
        #   • Озон Банк — карточка заведена, отзывов вообще нет;
...
SHORT_NAMES = {
    ...
    "vtb": "ВТБ", "sovcom": "Совкомбанк", "ozon": "Озон Банк",
...
def context_block(banks=None, refresh=False, limit=30):
    ...
    out += [
        ...
        "Озон Банк на banki.ru — карточка есть, отзывов ноль, точка отсчёта по "
